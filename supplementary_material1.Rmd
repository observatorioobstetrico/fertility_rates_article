...
* **Davies Bouldin (medoid):** the lower the better (kmeans3, followed by kmedoids3 and kmeans4);
* **Dunn Index:** the higher the better (kmeans4, followed by ward3 and kmeans3);
* **Silhouette Index:** the higher the better (ward2, followed by kmedoids4, kmeans4 and kmeans3);
...
Thus, the chosen method was the **K-Means with K = 3**, since it presented the best Davies-Bouldin (medoid) index, the second best Calinski-Harabasz indices and good Dunn and Silhouette indices.
...
* **Davies Bouldin (centroid):** the lower the better (ward4, followed by kmeans4 and kmeans3);
* **Davies Bouldin (medoid):** the lower the better (ward4, followed by kmeans4 and kmeans3);
* **Dunn Index:** the higher the better (ward4, followed by kmeans4 and kmeans3);
* **Silhouette Index:** the higher the better (ward2, followed by kmeans4 and kmeans3);
* **Calinski-Harabasz (centroid):** the higher the better (kmeans4, followed by ward4 and kmeans3);
* **Calinski-Harabasz (medoid):** the higher the better (kmeans4, followed by ward4 and kmeans3).
...
Thus, the chosen method was the **K-Means with K = 3**, since it had the best overall performance after these two.
...
* **Davies Bouldin (centroid):** the lower the better (kmeans3, followed by ward3 and kmeans4)
...
* **Silhouette Index:** the higher the better (kmeans3, followed by ward3)
* **Calinski-Harabasz (centroid):** the higher the better (kmeans4, followed by kmeans3)
* **Calinski-Harabasz (medoid):** the higher the better (kmeans4, followed by kmeans3)
...
* **Davies Bouldin (centroid):** the lower the better (kmeans4, followed by ward3 and kmeans3);
* **Davies Bouldin (medoid):** the lower the better (kmeans4, followed by kmeans3 and ward3);
* **Dunn Index:** the higher the better (kmeans4, followed by kmeans3);
* **Silhouette Index:** the higher the better (kmeans4, followed by kmeans3);
* **Calinski-Harabasz (centroid):** the higher the better (kmeans4, followed by kmeans3);
* **Calinski-Harabasz (medoid):** the higher the better (kmeans4, followed by kmeans3).

**Choice:** even though, this time around, the K-Means with K = 4 didn't have problems with too few municipalities in a cluster, we chose the **K-Means with K = 3 ** to make it "comparable" with the other chosen clustering methods.
